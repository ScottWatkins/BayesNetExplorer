...
Input: Observations in rows, variables in columns. The dataframe is simply the bne dataframe from the format_data() function. The dataframe should not contain sample names
