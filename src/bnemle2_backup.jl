"""
    bnemle2(data, "P(Y=y1|X1=x1, X2=x2)")
...
"""
function bnemle2(data::Union{String,DataFrame}, query::String; q2::String="", digits::Int64=6, k::Number=1, outfile::String="", bootstraps::Int64=0, mincounts::Array=[1,20], outfile2::String="" )
